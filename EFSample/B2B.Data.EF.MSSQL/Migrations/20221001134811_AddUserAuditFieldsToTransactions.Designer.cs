...
namespace B2B.Data.EF.Migrations
{
    ...
    [Migration("20221001134811_AddUserAuditFieldsToTransactions")]
    partial class AddUserAuditFieldsToTransactions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("B2B.Objects.Dtos.BucketOverview", b =>
                {
            ...
            modelBuilder.Entity("B2B.Objects.Dtos.TopCompany", b =>
                {
                    b.Property<string>("CalendarMonth")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Funding.Offer.OfferAuditItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Logging.AuditItemLevelEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Payments.RemittanceAdviceAuditItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Transactions.CreditAuditItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Transactions.InvoiceAuditItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Transactions.PurchaseOrderAuditItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Funding.Offer.OfferAuditItem", b =>
                {
                    b.HasOne("B2B.Objects.Entities.Logging.AuditItemLevelEntity", "AuditItemLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Payments.RemittanceAdvice", b =>
                {
                    b.HasOne("B2B.Objects.Entities.Security.B2BUser", null)
                        .WithMany("RAHeads")
            ...
            modelBuilder.Entity("B2B.Objects.Entities.Payments.RemittanceAdviceLine", b =>
                {
                    ...
                    b.HasOne("B2B.Objects.Entities.Funding.Offer.Offer", null)
                        .WithMany("RemittanceAdviceLines")
                        .HasForeignKey("OfferId");
